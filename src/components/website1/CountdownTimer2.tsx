    ...
    <div className="flex gap-4 justify-center">
      {isClient && timeLeft ? (
        timerComponents.map(({ key, label }) => (
          <div
            key={key}
            className="bg-white rounded-xl shadow-md p-3 md:p-4 text-center w-24 font-marcellus"
          >
            <span className="block text-3xl  text-ColorWeb2">
        ...
        <span className="text-ColorWeb2 font-marcellus text-xl tracking-widest">
