...
export default function Contact() {
  ...
  return (
    <section id="rsvp" className="w-full relative py-10 bg-ColorWeb1">
      <div className="max-w-6xl mx-auto bg-white p-8 border border-gray-200 md:rounded-2xl md:hadow-lg">
        <h2 className=" text-3xl md:text-5xl text-ColorWeb2 text-center mb-10 font-marcellus">
          Potwierdź Obecność
        </h2>
        <form>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6 font-marcellus">
            {/* Name */}
            <div className="flex flex-col">
              <label
                className="block text-ColorWeb3 text-base md:text-lg font-medium mb-2"
                htmlFor="name"
              >
                Imię i Nazwisko *
              </label>
            ...
            {showChildrenDetails &&
              Array.from({ length: childrenCount }).map((_, index) => (
                <React.Fragment key={index}>
                  <div className="flex flex-col">
                    <label className="block text-ColorWeb3 text-base md:text-lg font-medium mb-2">
          ...
          <div className="flex items-center justify-center mt-8">
            <button
              className="bg-ColorWeb2 hover:bg-ColorWeb3 font-marcellus text-white tracking-widest py-3 px-6 rounded-full focus:outline-none focus:shadow-outline flex items-center gap-2 transition-colors duration-300"
              type="submit"
            >
              Potwierdź Obecność
            </button>
